        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<int>(nullable: false),
                    OriginalFreeform = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Identifications_Contacts_ContactId",
                        column: x => x.ContactId,
                        principalTable: "Contacts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CivilStatus = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventItems_Contacts_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeInMbs = table.Column<double>(nullable: false),
                    ContentType = table.Column<string>(nullable: true),
                    EventItemId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Documents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Documents_EventItems_EventItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Contacts_CreatorId",
                        column: x => x.CreatorId,
                        principalTable: "Contacts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Events_Documents_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventItems_CreatorId",
                table: "EventItems",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_EventItems_ImageId",
                table: "EventItems",
                column: "ImageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Identifications_ContactId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_EventItems_Documents_ImageId",
                table: "EventItems",
                column: "ImageId",
                principalTable: "Documents",
                principalColumn: "Id",
